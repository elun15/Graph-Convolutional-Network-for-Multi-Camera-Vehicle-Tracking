...
class Backbone(nn.Module):
    def __init__(self, num_classes, cfg):
        ...
        if model_name == 'resnet50':
            ...
            self.in_planes = 2048
            self.base = resnet101(num_classes=num_classes, pretrained=True)
            ...
            self.in_planes = 2048
            self.base = resnet101_ibn_a(last_stride, frozen_stages=cfg.MODEL.FROZEN, pretrained=False)
        ...
        elif model_name == 'resnet101_ibn_a_imagenet':
            self.in_planes = 2048
            self.base = resnet101_ibn_a(last_stride, frozen_stages=cfg.MODEL.FROZEN, pretrained=True)
            print('using resnet101_ibn_a IMAGENET as a backbone')
    ...
    def load_param(self, trained_path):
        ...
        for i in param_dict:
            if 'classifier' in i or 'arcface' in i:
                continue
            # self.base.state_dict()[i.replace('module.','')].copy_(param_dict[i])
