...
from torchvision.transforms import (
    Resize, Compose, ToTensor, Normalize, ColorJitter, RandomHorizontalFlip, RandomResizedCrop
)
...
def build_transforms(
    ...
    if 'random_resize_crop' in transforms:
        a=1
        transform_tr += [RandomResizedCrop((height, width),scale=(0.5,1.0),ratio=(0.7,1.3))]
    else:
