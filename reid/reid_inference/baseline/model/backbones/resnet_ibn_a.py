...
model_urls = {
    ...
    'resnet101_ibn_imagenet': 'https://github.com/XingangPan/IBN-Net/releases/download/v1.0/resnet101_ibn_a-59ea0ac6.pth',
}
...
def resnet101_ibn_a(last_stride, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet101_ibn_imagenet']))
    return model
